module FollowingsHelper
  ...
  def follow_user_button(user)
    ...
    return "<a class=f-b href=#{follow_user_path(user)}><i class=\"fas fa-user-plus fa-xl\"></i></a>".html_safe if cf

    return "<a class=f-b href=#{unfollow_user_path(user)}><i class=\"fas fa-times fa-xl\"></i></a>".html_safe if cu
